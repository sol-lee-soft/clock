...
1. Deploy the `index.html` file to your GitHub Pages repository.
2. Open the direct live URL in your mobile browser (e.g., `https://sol-lee-softe.github.io/clock/index.html`).
